#ifndef FRMPAYMENTTYPETABLE_H
#define FRMPAYMENTTYPETABLE_H

#include <QWidget>
#include "frmtablebase.h"

namespace Ui {
class FrmPaymenttypeTable;
}
class GbsSession;

class FrmPaymenttypeTable : public QWidget, public FrmTableBase
{
    Q_OBJECT

public:
    explicit FrmPaymenttypeTable(QWidget *parent = 0);
    ~FrmPaymenttypeTable();
...
private:
    ...
    Ui::FrmPaymenttypeTable *ui;
    QMenu *m_tableMenu;
    QString m_warehouseName;
};

#endif // FrmPaymenttypeTable_H
