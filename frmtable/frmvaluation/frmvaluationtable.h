#ifndef FRMVALUATIONTABLE_H
#define FRMVALUATIONTABLE_H

#include <QWidget>
#include "frmtablebase.h"

namespace Ui {
class FrmValuationTable;
}
class GbsSession;

class FrmValuationTable : public QWidget, public FrmTableBase
{
    Q_OBJECT

public:
    explicit FrmValuationTable(QWidget *parent = 0);
    ~FrmValuationTable();
...
private:
    ...
    Ui::FrmValuationTable *ui;
    QMenu *m_tableMenu;
    QString m_bankTypeName;
};

#endif // FRMVALUATIONTABLE_H
