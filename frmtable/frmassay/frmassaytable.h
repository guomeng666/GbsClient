#ifndef FRMASSAYTABLE_H
#define FRMASSAYTABLE_H
...
class FrmAssayTable : public QWidget, public FrmTableBase
{
    Q_OBJECT

public:
    explicit FrmAssayTable(QWidget *parent = 0);
    ~FrmAssayTable();
