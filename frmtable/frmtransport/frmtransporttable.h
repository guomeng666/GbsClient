#ifndef FRMTRANSPORTTABLE_H
#define FRMTRANSPORTTABLE_H

#include <QWidget>
#include "frmtablebase.h"

namespace Ui {
class FrmTransportTable;
}
class GbsSession;

class FrmTransportTable : public QWidget, public FrmTableBase
{
    Q_OBJECT

public:
    explicit FrmTransportTable(QWidget *parent = 0);
    ~FrmTransportTable();
...
private:
    ...
    Ui::FrmTransportTable *ui;
    QMenu *m_tableMenu;
    QString m_warehouseName;
};

#endif // FRMTRANSPORTTABLE_H
