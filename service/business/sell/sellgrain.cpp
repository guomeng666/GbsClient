...
void SellGrain::Execute(GbsSession &session)
{
    //封包处理
    ...
    rootObj.insert("ProcedureNum",QJsonValue(session.getRequestData("ProcedureNum")));
    rootObj.insert("Sell",QJsonValue(session.getRequestData("Sell")));
