...
EditUnload::EditUnload()
{

}

void EditUnload::Execute(GbsSession &session)
{
    //封包处理
    ...
    rootObj.insert("WareHouseID",QJsonValue(session.getRequestData("WareHouseID")));
    rootObj.insert("TakeCount",QJsonValue(session.getRequestData("TakeCount")));
