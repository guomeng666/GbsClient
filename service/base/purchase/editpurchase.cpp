...
void EditPurchase::Execute(GbsSession &session)
{
    //封包处理
    ...
    rootObj.insert("PurchaseName",QJsonValue(session.getRequestData("PurchaseName")));
    rootObj.insert("Sequence",QJsonValue(session.getRequestData("Sequence")));
