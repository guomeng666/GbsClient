...
QueryPaymenttype::QueryPaymenttype()
{

}

void QueryPaymenttype::Execute(GbsSession &session)
{
    //封包处理
    ...
    rootObj.insert("PaymentTypeName",QJsonValue(session.getRequestData("PaymentTypeName")));
