...
QueryContractType::QueryContractType()
{

}

void QueryContractType::Execute(GbsSession &session)
{
    //封包处理
    ...
    rootObj.insert("ContractTypeName",QJsonValue(session.getRequestData("ContractTypeName")));
