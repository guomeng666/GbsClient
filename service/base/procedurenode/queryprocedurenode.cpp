...
QueryProcedureNode::QueryProcedureNode()
{

}

void QueryProcedureNode::Execute(GbsSession &session)
{
    //封包处理
    ...
    rootObj.insert("ProcedureNodeName",QJsonValue(session.getRequestData("ProcedureNodeName")));
