...
QuerySampleClass::QuerySampleClass()
{

}

void QuerySampleClass::Execute(GbsSession &session)
{
    //封包处理
    ...
    rootObj.insert("SampleClassName",QJsonValue(session.getRequestData("SampleClassName")));
