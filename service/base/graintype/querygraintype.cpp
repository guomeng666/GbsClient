...
QueryGrainType::QueryGrainType()
{

}

void QueryGrainType::Execute(GbsSession &session)
{
    //封包处理
    ...
    rootObj.insert("GrainTypeName",QJsonValue(session.getRequestData("GrainTypeName")));
